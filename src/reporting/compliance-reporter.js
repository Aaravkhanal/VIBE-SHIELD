...
export class ComplianceReporter {
    ...
    _generateMarkdown(compliance) {
        ...
        md += `# 呪 VIBE SHIELD — OWASP Top 10 (2021) Compliance Report\n\n`;
        ...
        md += `\n*Compliance report generated by VIBE SHIELD 呪 v${meta.version}*\n`;
        return md;
    }
...
<head>
  ...
  <title>VIBE SHIELD OWASP Compliance — ${meta.target}</title>
  <style>
...
<body>
  <h1>呪 VIBE SHIELD — OWASP Top 10 Compliance</h1>
  <div class="meta">
  ...
  <footer>VIBE SHIELD 呪 v${meta.version} — OWASP Top 10 (2021) Compliance Report</footer>
</body>
</html>`;
    }
